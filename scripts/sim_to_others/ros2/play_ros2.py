...
class Quadruped_RL_Collection_Node(Node):
    ...
    def compute_rl_control(self):
        ...
        tau.FL = Kp * (desired_joint_pos.FL - joints_pos.FL) - Kd * joints_vel.FL
        tau.FR = Kp * (desired_joint_pos.FR - joints_pos.FR) - Kd * joints_vel.FR
        tau.RL = Kp * (desired_joint_pos.RL - joints_pos.RL) - Kd * joints_vel.RL
        tau.RR = Kp * (desired_joint_pos.RR - joints_pos.RR) - Kd * joints_vel.RR
        ...
        control_signal_msg.torques = np.concatenate([tau.FL, tau.FR, tau.RL, tau.RR], axis=0).flatten()
