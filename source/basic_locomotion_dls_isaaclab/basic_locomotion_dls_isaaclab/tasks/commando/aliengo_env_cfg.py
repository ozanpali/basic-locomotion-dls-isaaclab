...
class EventCfg:
    ...
    torque_scale_RL_hip = EventTerm(
        ...
        mode="startup",
        #interval_range_s=(5.0, 15.0),
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=["RL_hip_joint"]), "scale": 0.0},
    )
    torque_scale_RL_thigh = EventTerm(
        func=custom_events.scale_joint_torque,
        mode="startup",
        #interval_range_s=(5.0, 15.0),
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=["RL_thigh_joint"]), "scale": 0.0},
    )
    torque_scale_RL_calf = EventTerm(
        func=custom_events.scale_joint_torque,
        mode="startup",
        #interval_range_s=(5.0, 15.0),
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=["RL_calf_joint"]), "scale": 0.0},
    )
    ...
    torque_scale_RR_hip = EventTerm(
        ...
        mode="startup",
        #interval_range_s=(5.0, 15.0),
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=["RR_hip_joint"]), "scale": 0.0},
    )
    torque_scale_RR_thigh = EventTerm(
        func=custom_events.scale_joint_torque,
        mode="startup",
        #interval_range_s=(5.0, 15.0),
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=["RR_thigh_joint"]), "scale": 0.0},
    )
...
class AliengoFlatEnvCfg(DirectRLEnvCfg):
    ...
    joints_calf_position_reward_scale = -0.1 * (1-use_amp)
    ...
    commando_feet_air_time_reward_scale = 1.0 * (1-use_amp)
    commando_feet_slide_reward_scale = -0.25 * (1-use_amp)
    commando_feet_to_hip_distance_reward_scale = 0.25 * (1-use_amp)
    ...
    commando_joints_thigh_position_reward_scale = -0.001 * (1-use_amp)
