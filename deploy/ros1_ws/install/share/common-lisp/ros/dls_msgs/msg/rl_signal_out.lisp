...
(cl:defmethod cl:initialize-instance :after ((m <rl_signal_out>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'rl_signal_out)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dls_msgs-msg:<rl_signal_out> is deprecated: use dls_msgs-msg:rl_signal_out instead.")))
...
(cl:defmethod desired_joint_positions-val ((m <rl_signal_out>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dls_msgs-msg:desired_joint_positions-val is deprecated.  Use dls_msgs-msg:desired_joint_positions instead.")
